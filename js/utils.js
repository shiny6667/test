import { data } from './app.js'; // 导入 data

// This file contains utility functions for the Rhino Matching Game.

export function isMatch(text1, text2) {
...
export function checkGameOver(tiles, startTime, elapsedTime, gameContainer, gameOver) {
...
export function playAudio(text) {
    ...
    const audio = new Audio(`https://dict.youdao.com/dictvoice?type=2&audio=${encodedText}`);
    audio.play();
}
